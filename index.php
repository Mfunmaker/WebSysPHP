<?php
   //require 'model/CrudPHPDAO.php';
    ...
    $products=$crudPHPDAO->getProducts();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>CS 2033 | Crud PHP DAO Assignment</title>
...
<body>
    ...
    <a class="navbar-brand" href="listProducts.php">
        ...
        CS 2033 Web Systems CRUD PHP DAO Assignemt    </a>
    </nav>
    <div class="container">
        <div class="col">
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    <?php
                        for($index=0;$index<count($productss);$index++){
